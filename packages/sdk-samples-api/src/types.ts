...
export interface SampleQuery {
  ...
  resourceType?: string;      // Azure resource type: 'openai', 'cognitive-services', 'azure-ai'
}
...
export interface SampleMetadata {
  ...
  apiVersion?: string;
  sdkVersion?: string;
  resourceType?: string; // Azure resource type (e.g., 'openai', 'cognitive-services', 'azure-ai')
}
